...
namespace System.Windows.Media.Media3D
{
    ...
    public sealed partial class GeometryModel3D : Model3D
    {
        ...
        internal static void MaterialPropertyChangedHook(DependencyPropertyChangedEventArgs e)
        {
        }

        internal static void BackMaterialPropertyChangedHook(DependencyPropertyChangedEventArgs e)
        {
